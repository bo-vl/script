...
local Window = OrionLib:MakeWindow({Name = "Hydra Network |Mining Clicker Simulator|", HidePremium = false,IntroText = "Mining Clicker Simulator", SaveConfig = false, ConfigFolder = "OrionTest"})
