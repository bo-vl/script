...
local Window = OrionLib:MakeWindow({Name = "Hydra Network |Tapping Simulator!|", HidePremium = false, IntroText = "Tapping Simulator", SaveConfig = false, ConfigFolder = "OrionTest"})
