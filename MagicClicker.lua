...
local Window = OrionLib:MakeWindow({Name = "bo's script Hub |Magic Clicker|", HidePremium = false,IntroText = "Bo's Script Hub", SaveConfig = false, ConfigFolder = "OrionTest"})
